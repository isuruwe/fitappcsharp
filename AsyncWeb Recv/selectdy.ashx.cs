...
namespace AsyncWeb_Recv
{
    ...
    /// </summary>
    public class selectdy : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            sqlQuery = "SELECT  SUM(km) as tkm, SUM(cal) as tcal , DAY(dtval) as dy FROM[fitapp].[dbo].[fit] where year(dtval) = '"+dt+"' and month(dtval) = '"+mnth+"'  group by DAY(dtval) ";
